...
DARK = dict(name="banner.svg", wordmark="#edf0f8")
LIGHT = dict(name="banner-light.svg", wordmark="#15182e")
...
def banner(t: dict) -> str:
  ...
  <svg x="{MARK_X}" y="{PAD_Y}" width="{MARK_SIZE}" height="{MARK_SIZE}" viewBox="0 0 512 512">
    {mark_block()}
  </svg>
...
def check() -> None:
    ...
    for theme in (DARK, LIGHT):
        ...
        assert "mark-c" in ids, "the mark's ids stopped being prefixed"
